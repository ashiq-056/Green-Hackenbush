...
void sound()
{
    //sndPlaySound("C:\\Users\\habibur.rahman\\Desktop\\AI\\test\\background_sound.wav", SND_ASYNC);
...
int main(int argc,char** argv)
{
    ...
    glutCreateWindow("Hackenbush");//creates the window as specified by the user as above.

    glClearColor(0.2, 0.2, 0.2, 0); // sets the backgraound color to white light
